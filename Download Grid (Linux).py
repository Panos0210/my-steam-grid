...
class Worker(QObject):
    ...
    def run(self):
        ...
        output = os.path.join(temp_dir, 'grid.zip')
        extracted_dir = os.path.join(temp_dir, 'extracted_repo')
        ...
        try:
            ...
            config_folder_path = os.path.join(extracted_dir, "panso-steam-grid-main", "config")
...
def userdata_textbox_win():
    ...
    path_label = QLabel('Now you have to select the Steam/userdata folder directory on your pc\n'
                        rf'(Default Steam userdata folder directory on your system is: /home/{username}/.local/share/Steam/userdata)')
    path_label.setWordWrap(True)
    
    path_input = QLineEdit(rf"/home/{username}/.local/share/Steam/userdata")
